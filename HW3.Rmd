...
nes1992 = nes1992 %>% filter(!is.na(gender)) %>%
              ...
              filter(!is.na(ideo))
nes1992$race[nes1992$race==1] <- "white"
nes1992$race[nes1992$race==2] <- "black"
nes1992$race[nes1992$race==3] <- "asian"
nes1992$race[nes1992$race==4] <- "native american"
nes1992$race[nes1992$race==5] <- "hispanic"
nes1992$race[nes1992$race==7] <- "other"
nes1992$gender[nes1992$gender==1] <- "male"
nes1992$gender[nes1992$gender==2] <- "female"
nes1992$educ1[nes1992$educ1==1] <- "no high school"
nes1992$educ1[nes1992$educ1==2] <- "high school graduate"
nes1992$educ1[nes1992$educ1==3] <- "some college"
nes1992$educ1[nes1992$educ1==4] <- "college graduate"
nes1992$partyid3[nes1992$partyid3==1] <- "democrats"
nes1992$partyid3[nes1992$partyid3==2] <- "independents"
nes1992$partyid3[nes1992$partyid3==3] <- "republicans"
nes1992$partyid3[nes1992$partyid3==9] <- "apolitical"
nes1992$ideo[nes1992$ideo==1] <- "liberal"
nes1992$ideo[nes1992$ideo==3] <- "moderate"
nes1992$ideo[nes1992$ideo==5] <- "conservative"
...
```{r}
logreg <- glm(presvote-1 ~ race + educ1 + partyid3 + ideo + + income + partyid3:ideo + educ1:income, data=nes1992, family = binomial)
summary(logreg)
```
...
#There does not seem to be anything systematic about the distribution of residuals in the binned residual plot.
#The residuals appear to be randomly dispersed. They mostly fall between the grey confidence bands.
```
